<div x-data @click="const clicked = $event.target
        ...
        <div class="mt-8">
            @if ($hasVoted)
                <button wire:click.prevent="vote"
                    class="w-20 bg-blue font-bold text-xxs text-white uppercase rounded-xl px-4 py-3 border border-blue hover:bg-blue-hover transition duration-150 ease-in">
                    Voted
                </button>
            @else
                <button wire:click.prevent="vote"
